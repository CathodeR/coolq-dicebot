...
namespace dicebot::protocol {
    class protocol_manual_dice : public protocol_base {
        using manual_dice_call = std::function<bool(protocol_manual_dice const &, std::string const &, std::string const &, std::string &,
...
#define TMDICE_CALL(_Func_Name)                               \
    bool _Func_Name(protocol_manual_dice const &protocol_cal, \
...
#define TMDICE_CALL_NAMESPACE(_Func_Name)                               \
    bool protocol::_Func_Name(protocol_manual_dice const &protocol_cal, \
                              std::string const &message,               \
                              std::string const &nick_name,             \
                              std::string &response,                    \
                              int64_t const group_id,                   \
